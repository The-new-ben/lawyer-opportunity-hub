-- Add ratings for existing closed cases and lawyers
...
-- Create additional professional leads for diversity
...
VALUES
('חברת אמזון ישראל', '+972-3-1234567', 'legal@amazon.co.il', 'הקמת מרכז פיתוח בישראל והתאמה לדיני עבודה מקומיים', 'דיני מסחר', 'high', 800000, 'new', 'corporate'),
('סמסונג אלקטרוניקס', '+972-3-2345678', 'legal@samsung.co.il', 'מיזוג עם חברה ישראלית וניהול רכישת פטנטים', 'דיני מסחר', 'critical', 1200000, 'new', 'corporate'),
('מיקרוסופט ישראל', '+972-3-3456789', 'legal@microsoft.co.il', 'ייסוד חברת בת בישראל ופתיחת מרכז מחקר ופיתוח', 'דיני מסחר', 'high', 950000, 'assigned', 'corporate'),
('איגוד עובדי הבנקים', '+972-3-4567890', 'info@bankworkers.org.il', 'ניהול משא ומתן קיבוצי עם כל הבנקים הגדולים בישראל', 'דיני עבודה', 'critical', 450000, 'new', 'union'),
('ארגון צרכנים ישראל', '+972-3-5678901', 'legal@consumers.org.il', 'הגשת תביעה ייצוגית נגד חברות הסלולר על חיובים מוגזמים', 'דיני צרכנות', 'high', 320000, 'assigned', 'nonprofit');
