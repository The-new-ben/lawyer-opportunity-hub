  ...
  return (
    <div className="p-6 space-y-6 flex flex-col overflow-x-hidden">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold">לידים שסיפקת</h1>
          <p className="text-muted-foreground">ניהול ומעקב אחר הלידים שסיפקת</p>
        </div>
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              <DialogTitle>ספק ליד חדש</DialogTitle>
              <DialogDescription>
                הכנס ליד שסיפקת למערכת
              </DialogDescription>
            </DialogHeader>
            <Form {...form}>
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground mb-4">
                נסה לשנות את קריטריוני החיפוש או ספק ליד חדש
              </p>
              <Button onClick={() => setIsOpen(true)}>ספק ליד חדש</Button>
            </div>
          </CardContent>
        </Card>
      )}
